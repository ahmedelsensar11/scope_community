...
<div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-8  py-0 ">
                        <ul class="info-list ">
                            ...
                            <li>
                                <a name="" id="" class="btn btn-follow btn-primary py-2 px-4 my-2" href="editProfile.php" role="button">EDIT PROFILE</a>
                            </li>
                            <!-- Edit profile if id == user_id -->
                            <li class="text-muted  bio my-2 pr-0"><?php echo $user_details['user_bio']?></li>
    ...
    <?php } else {?>
        <div class="text-center no-user-posts">
